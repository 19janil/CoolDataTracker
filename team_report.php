                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                $t = $_POST['tname'];
                                                $res = mysqli_query($con , "SELECT * FROM tsalesteaminformation WHERE TeamName="."'".$t."'");
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                echo "<input type='text' class='form-control' disabled placeholder='-' value=$date >";
                                                ?>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
...
$a1 = mysqli_query($con ,"SELECT tprouctsalesdataprocessed.SalesCount, tproductinformations.Name FROM tprouctsalesdataprocessed , tproductinformations WHERE tproductinformations.Code = tprouctsalesdataprocessed.ProductCode");
