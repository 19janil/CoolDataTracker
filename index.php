                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                $res = mysqli_query($con , "SELECT * FROM tuserinfromations WHERE ID=1 ");
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <?php
                                                require_once('connection.php');
                                                $res = mysqli_query($con , "SELECT tsalesteaminformation.TeamName FROM tsalesteaminformation , tuserreportinghierarchy WHERE tuserreportinghierarchy.LeadsUserID = tsalesteaminformation.TeamLeadID AND MemberUserID=1");
                                                $row = mysqli_fetch_array($res);
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Date</label>                                               
                                                <?php
                                                echo '<input type="text" name="ddate" class="form-control" disabled placeholder="City" value="'.date("Y-m-d").'"> ';
                                                ?>
                                            </div>
                                        </div>
  ...
  <script type="text/javascript">
    ...
    function drawChart() {
      ...
      <?php
            ...
            $xyz = date("Y-m-d");
$a1 = mysqli_query($con ,"SELECT * FROM tsalesreports, tprouctsalesdataprocessed WHERE tprouctsalesdataprocessed.ID = tsalesreports.RecipientID AND tsalesreports.ReportDate = "."'".$xyz."'");
...
$a1 = mysqli_query($con ,"SELECT * FROM tsalesreports, tprouctsalesdataprocessed WHERE tprouctsalesdataprocessed.ID = tsalesreports.RecipientID AND tsalesreports.ReportDate = "."'".$xyz."'");
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $.notify({
                icon: 'pe-7s-clock',
                message: "Next Report will be Generated at <b>08:00 P.M.</b>"
